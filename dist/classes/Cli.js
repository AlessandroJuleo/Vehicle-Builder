...
class Cli {
    ...
    createMotorbike() {
        inquirer
            ...
            const motorbike = new Motorbike(Cli.generateVin(), answers.color, answers.make, answers.model, answers.year, answers.weight, answers.topSpeed, wheelsAnswersArray);
